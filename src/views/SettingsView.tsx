                ...
                <>
                  ...
                  <div className="form-group" style={{ marginBottom: 24 }}>
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: 14 }}>
                      ...
                      <div style={{ flex: 1 }}>
                        <input value={logoInput} onChange={e => setLogoInput(e.target.value)} placeholder="Paste image URL…" style={{ marginBottom: 4 }} />
                        <div style={{ fontSize: 11, color: 'var(--c4)' }}>Recommended: 512×512px, SVG or PNG</div>
                      </div>
                    </div>
                  </div>
          ...
          {[
            ...
            <div key={card.label} className="stat-card">
              ...
              <div style={{ display: 'flex', alignItems: 'baseline', gap: 6 }}>
                ...
                <span style={{ fontSize: 11, color: 'var(--c4)' }}>{card.sub}</span>
              </div>
            </div>
          ))}
        </div>
